...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:EXT:auth0_sso/Resources/Private/Language/locallang_db.xlf:tx_oauth_domain_model_beoidc',
        'label' => 'uid',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'searchFields' => '',
        'iconfile' => 'EXT:EXT:auth0_sso/Resources/Public/Icons/tx_oauth_domain_model_beoidc.gif'
    ],
    'interface' => [
